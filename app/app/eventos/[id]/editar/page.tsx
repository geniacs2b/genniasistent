...
export default async function EditarEventoPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <EventoForm evento={evento} isEdit tiposEvento={enrichedTiposEvento as any} config={config} />
    </div>
  );
}
