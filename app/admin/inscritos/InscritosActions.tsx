...
interface InscritosActionsProps {
  inscripciones: any[];
}

export function InscritosActions({ inscripciones }: InscritosActionsProps) {
  const exportCSV = () => {
  ...
  return (
    <Button variant="outline" className="gap-2 h-10 px-4 rounded-xl font-bold border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm" onClick={exportCSV}>
